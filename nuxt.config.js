...
module.exports = {
    ...
    link: [
      {
        rel: 'stylesheet',
        href:
          'https://fonts.googleapis.com/css?family=Poppins:100,400,500,600,700',
      },
      {
        rel: 'stylesheet',
  ...
  modules: ['bootstrap-vue/nuxt', '@nuxtjs/axios', '@nuxtjs/axios'],
  bootstrapVue: {
  ...
  plugins: [
    ...
    { src: '~/plugins/services/startups.js', ssr: false },
    { src: '~/plugins/services/investors.js', ssr: false },
    { src: '~/plugins/services/admin.js', ssr: false },
    { src: '~/plugins/services/storage.js', ssr: false },
