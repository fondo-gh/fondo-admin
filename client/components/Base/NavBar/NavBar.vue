...
<!-- 
                    ...
                    <b-nav-item-dropdown right
                        ...
                        <template slot="button-content">
                            <div class="d-flex text-right text-13">
                                <div class="d-none d-lg-flex  flex-column mr-1 avatar-description justify-content-center">
                                    ...
                                    <span class="text-navtop " v-if="user">{{user.admin.currentUser.name}} </span>
                        ...
                        <div class="ig-title-dropdown h6 d-flex align-items-begin justify-content-begin py-3 px-4">
                            <div> Hello, <strong> {{user.admin.currentUser.name}} </strong> </div>
                        </div>
...
export default {
  ...
  data () {
    return {
      ...
      iconLighten2: true,
      iconVariant: 'theme1',
      user: JSON.parse(localStorage.getItem('fondoSync'))
    }
  },
